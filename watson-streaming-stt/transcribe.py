...
if __name__ == "__main__":
    main()
    transcript1 = "".join([x['results'][0]['alternatives'][0]['transcript']
                          for x in FINALS])
...
apikey = 'Mw18ew3MHA9aEVhMb8ukDdbymM4ooM3dSzNMidDwxX77'
url = 'https://api.eu-gb.text-to-speech.watson.cloud.ibm.com/instances/6ebd6548-4d1e-4248-8c60-9c5e8c97dc3b'
